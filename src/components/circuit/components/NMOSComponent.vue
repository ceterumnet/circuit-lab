<template>
  ...
  >
    ...
    <v-group :config="{ x: -30, y: -30 }">
      ...
      <!-- Body arrow on source (pointing outward - away from channel for NMOS) -->
      <v-line
        :config="{
          points: [23, 48, 21, 46, 21, 50, 23, 48],
          stroke: isSelected ? '#ff4d4d' : isHighlighted ? '#ffc107' : '#333',
          strokeWidth: 1,
...
// NMOS-specific computed properties for educational display
